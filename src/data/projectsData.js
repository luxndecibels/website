...
export const allProjects = [
  ...
  },
  {
    ...
    name: 'PATNA SAHIB GURUDWARA', state: 'BIHAR', type: 'Sound & Light Show', tech: 'Projection Mapping',
    images: [patna1, patna2],
    overview: `Shani Shingnapur is one of the most unique and revered temples in India, located in Ahmednagar district of Maharashtra. The temple is dedicated to Lord Shani (Saturn) and is celebrated for two extraordinary features — the deity is represented by a black self-manifested stone idol open to the sky without any roof, and for centuries the village surrounding it famously had no doors on any of its homes or businesses, a testament to unwavering faith in the deity's protection.\n\nLux Decibels designed a specially commissioned Sound & Light Show that narrates the mythological story of Lord Shani's origin and his significance in Hindu cosmology. The show uses wide-format projection on purpose-built screens around the open shrine, complemented by devotional music and an original narration that recounts the deity's legends. The lighting design uses deep indigo and violet tones — traditionally associated with Lord Shani — creating a deeply atmospheric and spiritually resonant experience that draws pilgrims and tourists from across Maharashtra.`,
  },
  {
  ...
  },
  {
    ...
    name: 'MADURAI JUNCTION', state: 'TAMIL NADU', type: 'Immersive Light Show', tech: 'Interactive Lighting',
    images: [madurai1, madurai2, madurai3],
    overview: `Belum Caves, located in Kurnool district of Andhra Pradesh, is the second-longest natural cave system on the Indian subcontinent, stretching over 3.2 kilometres. Formed over millions of years by the underground flow of the Chitravati River through limestone rock, the cave system features chambers of remarkable variety — from narrow tunnels to vast cathedral-like halls with formations up to 4 metres tall. Archaeological evidence shows the caves were used by Buddhist and Jain monks as early as 4500 BC.\n\nLux Decibels designed and installed a comprehensive interactive lighting system throughout the cave network. Responsive LED fixtures change colour and intensity based on visitor proximity, guiding guests through the natural passage while accentuating the geological formations in dramatic fashion. Each named chamber — the Thousand Hoods Room, the Meditation Hall, the Saptasvarala Guha — has its own lighting palette designed to amplify its character. The system runs entirely on renewable energy and includes emergency navigation lighting, making it both an artistic and safety-first installation.`,
  },
  {
